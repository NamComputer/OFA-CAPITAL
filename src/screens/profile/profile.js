  ...
  return (
    ...
    <View style={styles.container}>   
      <View style={styles.header}>
        <View/>
          <View style={styles.headerChild}>  
              ...
              <Text style={styles.subHeaderTitle}>Have a nice day! Mr/Mrs {nameUser}</Text>
          </View>
      ...
      <View style={styles.body}>
          <RectangleButton title={'👤　Product Management'} onpress={()=>navigation.navigate('EditProfile')} buttonColor={Colors.bottomBar} txtColor={Colors.dark} recBorderColor={Colors.bottomBar} recWidth={300} />
          <RectangleButton title={'💼　Subscription Management'} onpress={()=>navigation.navigate('mySubscription')} buttonColor={Colors.bottomBar} txtColor={Colors.dark} recBorderColor={Colors.bottomBar} recWidth={300} />
